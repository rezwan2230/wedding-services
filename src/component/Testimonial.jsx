            ...
            <section className="dark:bg-gray-800 dark:text-gray-100">
                <div className="container px-6 py-12 mx-auto">
                    <div className="grid items-center gap-4 xl:grid-cols-5">
                        ...
                        <h2 className="text-center text-5xl font-display mt-20 mb-5">What our customers are saying about us</h2>
                            <p className="dark:text-gray-400">People are drawn to us because of our unwavering commitment to excellence, personalized service, and trust we've cultivated through consistent reliability, innovation, and shared values. We're their top choice.</p>
                        </div>
                                ...
                                <div className="grid content-center gap-4">
                                    <div className="p-6 rounded shadow-md dark:bg-gray-900">
                                        ...
                                        <div className="flex items-center mt-4 space-x-4">
                                            ...
                                            <div>
                                                <p className="text-lg font-semibold">Praveen Juge</p>
                                    ...
                                    <div className="p-6 rounded shadow-md dark:bg-gray-900">
                                        ...
                                        <div className="flex items-center mt-4 space-x-4">
                                            ...
                                            <div>
                                                <p className="text-lg font-semibold">Distinctio Animi</p>
                                                <p className="text-sm dark:text-gray-400">Founder</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="grid content-center gap-4">
                                    <div className="p-6 rounded shadow-md dark:bg-gray-900">
                                        ...
                                        <div className="flex items-center mt-4 space-x-4">
                                            ...
                                            <div>
                                                <p className="text-lg font-semibold">Boris Kitua</p>
